...
<head>
  ...
  <title>Sistem Monitoring Kelas &mdash; SIMOK</title>
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  ...
                  Penanggung Jawab Ruangan J.4.8
                </a>
              </div>
              <div class="search-item">
                <a href="#">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">SIMOK</li>
            {{-- <li class="dropdown">
              <a href="/tabel" class="nav-link"><i class="fas fa-th-large"></i> <span>Tabel Data Ruangan</span></a>
              <ul class="dropdown-menu">
            ...
            {{-- <li class="dropdown">
              <a href="#" class="nav-link"><i class="far fa-file-alt"></i> <span>Forms</span></a>
              <ul class="dropdown-menu"> --}}
            ...
            <li>
                <a href="/pengisian" class="nav-link"><i class="far fa-file-alt"></i> <span>Form Pengisian Data Ruangan</span></a>
            </li>
            @endif
            {{-- <li class="dropdown">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">Detail Statistics -
                    <div class="dropdown d-inline">
                      <a class="font-weight-600 dropdown-toggle" data-toggle="dropdown" href="#" id="orders-month">March</a>
                      <ul class="dropdown-menu dropdown-menu-sm">
                        <li class="dropdown-title">Select Month</li>
                        <li><a href="#" class="dropdown-item">January</a></li>
                        <li><a href="#" class="dropdown-item">February</a></li>
                        <li><a href="#" class="dropdown-item active">March</a></li>
                  ...
                  <div class="card-stats-items">
                    ...
                    <div class="card-stats-item">
                      <div class="card-stats-item-count">03</div>
                      <div class="card-stats-item-label">Bulan</div>
                    </div>
                    <div class="card-stats-item">
                      <div class="card-stats-item-count">2023</div>
            ...
            {{-- <div class="col-lg-4 col-md-4 col-sm-12"> --}}
              {{-- <div class="card card-statistic-2"> --}}
                {{-- <div class="card-chart">
                  ...
                  <th>Monitor Ruangan Gedung Teknik Informatika dan Teknik Pencemaran Lingkungan</th>
                </div> --}}
                    ...
                    <table class="table table-striped">
                      ...
                      @foreach ($tb_ruangan as $r)
                        <tr>
                            ...
                            @if (auth()->user()->hak_akses == "admin")
                            <td>
                                <a href="/dashbord/{{$r->NO}}/edit" class="btn btn-sm btn-success">Edit</a>
                                {{-- <form action="/dashboard/{{$r->NO}}" method="post">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-sm btn-danger">Hapus</button>
                                </form> --}}
                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('dashboard/'.$r->NO) }}" method="post">
                                @csrf
                                @method('DELETE')
