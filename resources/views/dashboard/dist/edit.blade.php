...
<head>
  ...
  <title>Form &rsaquo; Form Pengisian Data &mdash; SIMOK</title>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            {{-- <li class="dropdown">
              <a href="/tabel" class="nav-link"><i class="fas fa-th-large"></i> <span>Tabel Ruangan</span></a>
              <ul class="dropdown-menu">
            ...
            <li class="dropdown active">
              <a href="/dashboard" class="nav-link "><i class="far fa-file-alt"></i> <span>Form Pengisian Data Ruangan</span></a>
              <ul class="dropdown-menu">
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Form Pengisian Data Ruangan</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="/dashboard">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="/dashboard">Form</a></div>
              <div class="breadcrumb-item">Form Pengisian Data Ruangan</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Form Pengisian Data Ruangan</h2>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <form action="/dashboard/{{$r->NO}}" class="forms-sample" method="POST">
                    @method('put')
                    @csrf
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="id_ruangan" value="{{$tb_pemasukan->id_ruangan}}" class="form-control" required="">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group mb-0">
                        ...
                        <textarea class="form-control" name="PJ" required=""></textarea>
                      </div>
                    </div>
